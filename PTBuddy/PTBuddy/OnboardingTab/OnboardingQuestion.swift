...
let onboardingQuestions = [
    ...
    OnboardingQuestion(id: 8, mainTitle: "탄수화물 섭취 횟수 밥, 빵, 면, 고구마, 과일 등의 탄수화물을 얼마나 자주 먹나요?", subTitle: "한끼 기준 주먹 1개 이상의 양을 먹은 횟수", answers: ["매 식사마다", "하루 식사 중 절반", "하루 한 번 정도", "일주일에 3~4번 정도", "일주일에 1~2번 정도"]),
    OnboardingQuestion(id: 9, mainTitle: "달걀, 고기, 해산물, 유제품 들의 단백질을 얼마나 자주 먹나요?", subTitle: "한끼 기준 주먹 1개 이상의 양을 먹은 횟수", answers: ["매 식사마다 ", "하루 식사 중 절반 ", "하루 한 번 정도 ", "일주일에 3~4번 정도 ", "일주일에 1~2번 정도 "]),
    OnboardingQuestion(id: 10, mainTitle: "채소는 얼마나 자주 먹나요?", subTitle: "한끼 기준 주먹 1개 이상의 양을 먹은 횟수", answers: ["매 식사마다", "하루 식사 중 절반", "하루 한 번 정도", "일주일에 3~4번 정도", "일주일에 1~2번 정도"]),
    OnboardingQuestion(id: 11, mainTitle: "하루 물 섭취량", subTitle: "하루에 얼마나 많은 물을 마시나요?", answers: ["500ml 미만", "500ml~1L 미만", "1L 이상~1.2L 미만", "1.2L 이상~1.4L 미만", "1.4L 이상~2L 미만", "2L 이상"]),
    ...
    OnboardingQuestion(id: 21, mainTitle: "목표 몸무게는 어떻게 되시나요?"),
    OnboardingQuestion(id: 22, mainTitle: "주요 목표는 무엇인가요?", answers: ["근육 증가", "체지방 감소", "현재 상태 유지"]),
    OnboardingQuestion(id: 23, mainTitle: "주로 어디서 운동하나요?", answers: ["헬스장", "집"]),
    OnboardingQuestion(id: 24, mainTitle: "어떤 운동을 선호하나요?", answers: ["맨몸 운동", "기구 운동"]),
    OnboardingQuestion(id: 25, mainTitle: "일주일에 몇 번 운동하실 예정인가요?", answers: ["1일", "2일", "3일", "4일", "5일", "6일", "7일"])
]
